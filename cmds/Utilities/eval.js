...
exports.func = async (message, args) => {
	...
	try {
		...
		const params = `api_dev_key=${key}&api_option=paste&api_paste_code=${evaled}&api_paste_private=1&api_paste_name=Eval&api_paste_format=javascript&api_paste_expire_date=10M`;
